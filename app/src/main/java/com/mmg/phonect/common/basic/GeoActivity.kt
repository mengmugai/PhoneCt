...
import com.mmg.phonect.common.basic.insets.FitHorizontalSystemBarRootLayout
...
abstract class GeoActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        PhoneCt.instance.addActivity(this)
    ...
    override fun onNewIntent(intent: Intent) {
        ...
        PhoneCt.instance.setTopActivity(this)
    }
    ...
    override fun onPause() {
        super.onPause()
        PhoneCt.instance.checkToCleanTopActivity(this)
    }

    @CallSuper
    override fun onDestroy() {
        super.onDestroy()
        PhoneCt.instance.removeActivity(this)
    }
