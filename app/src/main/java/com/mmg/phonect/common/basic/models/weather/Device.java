...
//    public String allowMockLocation;
    ...
    // 保存所有异常信息
    public List<Disease> allDiseaseInfo;
    ...
    public Device(String androidid, String imei, String imei2, String meid, String meid2, String ua, String macAddress, String serial,  List<Disease> allDiseaseInfo) {
...
//    }
    ...
    public List<Disease> getAllDiseaseInfo() {
        return allDiseaseInfo;
    }

    public void setAllDiseaseInfo(List<Disease> allDiseaseInfo) {
        this.allDiseaseInfo = allDiseaseInfo;
    }
