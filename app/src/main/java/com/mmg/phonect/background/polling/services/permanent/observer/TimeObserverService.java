package com.mmg.phonect.background.polling.services.permanent.observer;
...
import com.mmg.phonect.background.polling.services.permanent.update.ForegroundNormalUpdateService;
import com.mmg.phonect.background.polling.services.permanent.update.ForegroundTodayForecastUpdateService;
import com.mmg.phonect.background.polling.services.permanent.update.ForegroundTomorrowForecastUpdateService;
...
public class TimeObserverService extends Service {
    ...
    private void startForeground() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            NotificationChannel channel = new NotificationChannel(
                    PhoneCt.NOTIFICATION_CHANNEL_ID_BACKGROUND,
                    PhoneCt.getNotificationChannelName(
                            this, PhoneCt.NOTIFICATION_CHANNEL_ID_BACKGROUND),
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            startForeground(
                    PhoneCt.NOTIFICATION_ID_RUNNING_IN_BACKGROUND,
    ...
    public static Notification getForegroundNotification(Context context, boolean setIcon) {
        return new NotificationCompat.Builder(context, PhoneCt.NOTIFICATION_CHANNEL_ID_BACKGROUND)
