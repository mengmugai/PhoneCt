...
public class CMWeatherProviderService extends WeatherProviderService
        implements DeviceHelper.OnRequestWeatherListener {
...
//                        CMWeatherProviderService.this);
    ...
    private final DeviceHelper.OnRequestLocationListener weatherLocationListener
            = new DeviceHelper.OnRequestLocationListener() {
        @Override
