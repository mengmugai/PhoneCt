...
public class DailyEntityGenerator {
    ...
    public static List<DailyEntity> generate(String cityId, WeatherSource source,
    ...
    public static Daily generate(DailyEntity entity) {
        return new Daily(
    ...
    public static List<Daily> generate(List<DailyEntity> entityList) {
