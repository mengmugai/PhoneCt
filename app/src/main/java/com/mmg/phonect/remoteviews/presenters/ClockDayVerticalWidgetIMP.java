...
import com.mmg.phonect.background.receiver.widget.WidgetClockDayVerticalProvider;
    ...
    private static void setOnClickPendingIntent(Context context, RemoteViews views, Location location,
        ...
        views.setOnClickPendingIntent(
                ...
                getWeatherPendingIntent(
                        context,
                        location,
                        PhoneCt.WIDGET_CLOCK_DAY_VERTICAL_PENDING_INTENT_CODE_WEATHER
                )
        );
        ...
        views.setOnClickPendingIntent(
                ...
                getAlarmPendingIntent(
                        context,
                        PhoneCt.WIDGET_CLOCK_DAY_VERTICAL_PENDING_INTENT_CODE_CLOCK_LIGHT
                )
        );
        views.setOnClickPendingIntent(
                ...
                getAlarmPendingIntent(
                        context,
                        PhoneCt.WIDGET_CLOCK_DAY_VERTICAL_PENDING_INTENT_CODE_CLOCK_NORMAL
                )
        );
        views.setOnClickPendingIntent(
                ...
                getAlarmPendingIntent(
                        context,
                        PhoneCt.WIDGET_CLOCK_DAY_VERTICAL_PENDING_INTENT_CODE_CLOCK_BLACK
                )
        );
        views.setOnClickPendingIntent(
                ...
                getAlarmPendingIntent(
                        context,
                        PhoneCt.WIDGET_CLOCK_DAY_VERTICAL_PENDING_INTENT_CODE_CLOCK_1_LIGHT
                )
        );
        views.setOnClickPendingIntent(
                ...
                getAlarmPendingIntent(
                        context,
                        PhoneCt.WIDGET_CLOCK_DAY_VERTICAL_PENDING_INTENT_CODE_CLOCK_1_NORMAL
                )
        );
        views.setOnClickPendingIntent(
                ...
                getAlarmPendingIntent(
                        context,
                        PhoneCt.WIDGET_CLOCK_DAY_VERTICAL_PENDING_INTENT_CODE_CLOCK_1_BLACK
                )
        );
        views.setOnClickPendingIntent(
                ...
                getAlarmPendingIntent(
                        context,
                        PhoneCt.WIDGET_CLOCK_DAY_VERTICAL_PENDING_INTENT_CODE_CLOCK_2_LIGHT
                )
        );
        views.setOnClickPendingIntent(
                ...
                getAlarmPendingIntent(
                        context,
                        PhoneCt.WIDGET_CLOCK_DAY_VERTICAL_PENDING_INTENT_CODE_CLOCK_2_NORMAL
                )
        );
        views.setOnClickPendingIntent(
                ...
                getAlarmPendingIntent(
                        context,
                        PhoneCt.WIDGET_CLOCK_DAY_VERTICAL_PENDING_INTENT_CODE_CLOCK_2_BLACK
                )
        );
        ...
        if (subtitleData.equals("lunar")) {
            views.setOnClickPendingIntent(
                    ...
                    getCalendarPendingIntent(
                            context,
                            PhoneCt.WIDGET_DAY_PENDING_INTENT_CODE_CALENDAR
                    )
            );
        }
    }
