...
import com.mmg.phonect.background.receiver.widget.WidgetWeekProvider;
    ...
    private static void setOnClickPendingIntent(Context context, RemoteViews views, Location location,
        ...
        views.setOnClickPendingIntent(
                ...
                getWeatherPendingIntent(
                        context,
                        location,
                        PhoneCt.WIDGET_WEEK_PENDING_INTENT_CODE_WEATHER
                )
        );
        ...
        if (viewType.equals("3_days")) {
            views.setOnClickPendingIntent(
                    ...
                    getDailyForecastPendingIntent(
                            ...
                            location,
                            0,
                            PhoneCt.WIDGET_WEEK_PENDING_INTENT_CODE_DAILY_FORECAST_1
                    )
            );
            views.setOnClickPendingIntent(
                    R.id.widget_week_icon_2,
                    getDailyForecastPendingIntent(
                            ...
                            location,
                            1,
                            PhoneCt.WIDGET_WEEK_PENDING_INTENT_CODE_DAILY_FORECAST_2
                    )
            );
            views.setOnClickPendingIntent(
                    R.id.widget_week_icon_3,
                    getDailyForecastPendingIntent(
                            ...
                            location,
                            2,
                            PhoneCt.WIDGET_WEEK_PENDING_INTENT_CODE_DAILY_FORECAST_3
                    )
            );
            views.setOnClickPendingIntent(
                    R.id.widget_week_icon_4,
                    getDailyForecastPendingIntent(
                            ...
                            location,
                            3,
                            PhoneCt.WIDGET_WEEK_PENDING_INTENT_CODE_DAILY_FORECAST_4
                    )
            );
            views.setOnClickPendingIntent(
                    R.id.widget_week_icon_5,
                    getDailyForecastPendingIntent(
                            ...
                            location,
                            4,
                            PhoneCt.WIDGET_WEEK_PENDING_INTENT_CODE_DAILY_FORECAST_5
                    )
            );
        }
    }
