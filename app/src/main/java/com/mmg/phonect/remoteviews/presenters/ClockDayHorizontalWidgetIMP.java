...
import com.mmg.phonect.background.receiver.widget.WidgetClockDayHorizontalProvider;
    ...
    private static void setOnClickPendingIntent(Context context, RemoteViews views, Location location) {
        ...
        views.setOnClickPendingIntent(
                ...
                getWeatherPendingIntent(
                        context,
                        location,
                        PhoneCt.WIDGET_CLOCK_DAY_HORIZONTAL_PENDING_INTENT_CODE_WEATHER
                )
        );
        ...
        views.setOnClickPendingIntent(
                ...
                getAlarmPendingIntent(
                        context,
                        PhoneCt.WIDGET_CLOCK_DAY_HORIZONTAL_PENDING_INTENT_CODE_CLOCK_LIGHT
                )
        );
        views.setOnClickPendingIntent(
                ...
                getAlarmPendingIntent(
                        context,
                        PhoneCt.WIDGET_CLOCK_DAY_HORIZONTAL_PENDING_INTENT_CODE_CLOCK_NORMAL
                )
        );
        views.setOnClickPendingIntent(
                ...
                getAlarmPendingIntent(
                        context,
                        PhoneCt.WIDGET_CLOCK_DAY_HORIZONTAL_PENDING_INTENT_CODE_CLOCK_BLACK
                )
        );
        ...
        views.setOnClickPendingIntent(
                ...
                getCalendarPendingIntent(
                        context,
                        PhoneCt.WIDGET_CLOCK_DAY_HORIZONTAL_PENDING_INTENT_CODE_CALENDAR
                )
        );
    }
}
