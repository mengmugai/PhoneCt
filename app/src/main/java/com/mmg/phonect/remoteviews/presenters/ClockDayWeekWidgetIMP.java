...
import com.mmg.phonect.background.receiver.widget.WidgetClockDayWeekProvider;
    ...
    private static void setOnClickPendingIntent(Context context, RemoteViews views, Location location) {
        ...
        views.setOnClickPendingIntent(
                ...
                getWeatherPendingIntent(
                        context,
                        location,
                        PhoneCt.WIDGET_CLOCK_DAY_WEEK_PENDING_INTENT_CODE_WEATHER
                )
        );
        ...
        views.setOnClickPendingIntent(
                ...
                getDailyForecastPendingIntent(
                        ...
                        location,
                        0,
                        PhoneCt.WIDGET_CLOCK_DAY_WEEK_PENDING_INTENT_CODE_DAILY_FORECAST_1
                )
        );
        views.setOnClickPendingIntent(
                R.id.widget_clock_day_week_icon_2,
                getDailyForecastPendingIntent(
                        ...
                        location,
                        1,
                        PhoneCt.WIDGET_CLOCK_DAY_WEEK_PENDING_INTENT_CODE_DAILY_FORECAST_2
                )
        );
        views.setOnClickPendingIntent(
                R.id.widget_clock_day_week_icon_3,
                getDailyForecastPendingIntent(
                        ...
                        location,
                        2,
                        PhoneCt.WIDGET_CLOCK_DAY_WEEK_PENDING_INTENT_CODE_DAILY_FORECAST_3
                )
        );
        views.setOnClickPendingIntent(
                R.id.widget_clock_day_week_icon_4,
                getDailyForecastPendingIntent(
                        ...
                        location,
                        3,
                        PhoneCt.WIDGET_CLOCK_DAY_WEEK_PENDING_INTENT_CODE_DAILY_FORECAST_4
                )
        );
        views.setOnClickPendingIntent(
                R.id.widget_clock_day_week_icon_5,
                getDailyForecastPendingIntent(
                        ...
                        location,
                        4,
                        PhoneCt.WIDGET_CLOCK_DAY_WEEK_PENDING_INTENT_CODE_DAILY_FORECAST_5
                )
        );
        ...
        views.setOnClickPendingIntent(
                ...
                getAlarmPendingIntent(
                        context,
                        PhoneCt.WIDGET_CLOCK_DAY_WEEK_PENDING_INTENT_CODE_CLOCK_LIGHT
                )
        );
        views.setOnClickPendingIntent(
                ...
                getAlarmPendingIntent(
                        context,
                        PhoneCt.WIDGET_CLOCK_DAY_WEEK_PENDING_INTENT_CODE_CLOCK_NORMAL
                )
        );
        views.setOnClickPendingIntent(
                ...
                getAlarmPendingIntent(
                        context,
                        PhoneCt.WIDGET_CLOCK_DAY_WEEK_PENDING_INTENT_CODE_CLOCK_BLACK
                )
        );
        ...
        views.setOnClickPendingIntent(
                ...
                getCalendarPendingIntent(
                        context,
                        PhoneCt.WIDGET_CLOCK_DAY_WEEK_PENDING_INTENT_CODE_CALENDAR
                )
        );
    }
}
