package com.mmg.phonect.theme.resource.utils;

import com.mmg.phonect.common.basic.models.weather.WeatherCode;

public class Constants {

    public static final String ACTION_ICON_PROVIDER = "com.mmg.phonect.ICON_PROVIDER";
    public static final String CATEGORY_CHRONUS_ICON_PACK = "com.dvtonder.chronus.ICON_PACK";

    public static final String META_DATA_PROVIDER_CONFIG = "com.mmg.phonect.PROVIDER_CONFIG";
    public static final String META_DATA_DRAWABLE_FILTER = "com.mmg.phonect.DRAWABLE_FILTER";
    public static final String META_DATA_ANIMATOR_FILTER = "com.mmg.phonect.ANIMATOR_FILTER";
    public static final String META_DATA_SHORTCUT_FILTER = "com.mmg.phonect.SHORTCUT_FILTER";
    public static final String META_DATA_SUN_MOON_FILTER = "com.mmg.phonect.SUN_MOON_FILTER";
