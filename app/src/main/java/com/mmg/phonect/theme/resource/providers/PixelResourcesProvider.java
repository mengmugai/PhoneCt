...
import com.mmg.phonect.common.ui.images.pixel.PixelMoonDrawable;
import com.mmg.phonect.common.ui.images.pixel.PixelSunDrawable;
...
public class PixelResourcesProvider extends IconPackResourcesProvider {
    ...
    public static boolean isPixelIconProvider(@NonNull String packageName) {
        return packageName.equals(
                PhoneCt.getInstance().getPackageName() + ".Pixel"
        );
    }
