package com.mmg.phonect.theme.resource.providers;
...
import com.mmg.phonect.theme.resource.utils.Constants;
import com.mmg.phonect.theme.resource.utils.ResourceUtils;
import com.mmg.phonect.theme.resource.utils.XmlHelper;
import com.mmg.phonect.common.ui.images.MoonDrawable;
import com.mmg.phonect.common.ui.images.SunDrawable;
...
public class DefaultResourceProvider extends ResourceProvider {
    ...
    public DefaultResourceProvider() {
        mContext = PhoneCt.getInstance();
        mProviderName = mContext.getString(R.string.phone_ct);
    ...
    public static boolean isDefaultIconProvider(@NonNull String packageName) {
        return packageName.equals(
                PhoneCt.getInstance().getPackageName());
    }
